<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"E:\PHP\project\zd\public/../application/home\view\cases\case_detail.html";i:1516118059;s:65:"E:\PHP\project\zd\public/../application/home\view\pub\header.html";i:1515513717;s:65:"E:\PHP\project\zd\public/../application/home\view\pub\footer.html";i:1514906749;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
  ...
  <div class="navbar sidebar-v2">
   <div class="container-fluid" id="sidebar-v2__accordion">
    <div class="navbar-header   ">
     ...
     <h1 class="dropdown-toggle sidebar-v2__h1 btn " data-toggle="collapse" data-target="#sidebar-v2__list3" data-parent="#sidebar-v2__accordion"> <button type="button" disabled="disabled"></button> <span>案例展示 </span> </h1>
    </div>
    <div class="panel">
     <div class="collapse navbar-collapse" id="sidebar-v2__list2">
      <ul class="nav navbar-nav navbar-right" id="collapseTwo">
       ...
       <li><a href="<?php echo url('cases/index',array('type'=>$vo['type'])); ?>"><?php echo $typeArr[$vo['type']]; ?></a></li>
       <?php endforeach; ?>
      </ul>
     </div>
    </div>
    ...
    <div id="showproduct"> 
     <div class="pshow v2-ac showproduct-v2__main"> 
       ...
       <div class="met_box"> 
        <div class="met_imgshowbox showproduct-v2"> 
         <div class="my-simple-gallery slides tab-content">
          ...
          <figure class="tab-pane fade  in active " id="pro_<?php echo $vo['article_imgID']; ?>">
           <a href="<?php echo $vo['url']; ?>"> <img src="<?php echo $vo['url']; ?>" alt="<?php echo $list['title']; ?>" />
            <!--x="720" y="400"--> </a>
           <figcaption>
            会议室
           </figcaption>
        ...
        <ul class="nav nav-pills showproduct-v2__list" role="tablist">
         ...
         <li class="active"><a href="#pro_<?php echo $vo['article_imgID']; ?>}" role="tab" data-toggle="tab"><img src="<?php echo $vo['url']; ?>" alt="<?php echo $list['title']; ?>" width="70" height="70" />
           <!--x="70" y="70"--></a></li>
         <?php endforeach; ?>
      ...
      <div class="col-sm-6 showproduct-v2__right"> 
       <div class="showproduct-v2__para"> 
        <h1 class="showproduct-v2__para__h1"><?php echo $list['title']; ?></h1>
        <ul class="v2-list showproduct-v2__para__ul"> 
         <li><span>面积</span>140m&sup2;</li> 
         <li><span>地址</span>中国</li> 
         <li><span>风格</span>现代</li> 
        </ul>
        <p class="desc">描述内容简介</p>
        <p class="desc"><?php echo $list['describe']; ?></p>
       </div>
      </div> 
     </div> 
     <div class="met_clear"></div> 
     ...
     <div class="met_nav_contbox"> 
      <div class="met_editor ">
       <div>
        <p><span style="font-family: monospace; font-size: medium; white-space: pre-wrap;">&nbsp;&nbsp;<?php echo $list['content']; ?></span></p>
     ...
     <div class="met_tools"> 
      ...
      <script type="text/javascript" src="/static/index/js/jia.js?uid=1346378669840136" charset="utf-8"></script>
      <span class="met_Clicks met_none">
       <!--累计浏览次数--></span> 
      <ul class="met_page">
       <?php if($list1): ?>
       <li class="met_page_preinfo"><span>上一条</span><a href="<?php echo url('cases/case_detail',array('articlesID'=>$list1['articlesID'])); ?>"><?php echo $list1['title']; ?></a></li>
       <?php endif; if($list2): ?>
       <li class="met_page_preinfo"><span>下一条</span><a href="<?php echo url('cases/case_detail',array('articlesID'=>$list2['articlesID'])); ?>"><?php echo $list2['title']; ?></a></li>
       <?php endif; ?>
      </ul> 
     </div> 
    </div> 
