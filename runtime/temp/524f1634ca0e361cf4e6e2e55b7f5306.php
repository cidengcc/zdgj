<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\PHP\project\zd\public/../application/home\view\contact\index.html";i:1515512870;s:65:"E:\PHP\project\zd\public/../application/home\view\pub\header.html";i:1515513717;s:65:"E:\PHP\project\zd\public/../application/home\view\pub\footer.html";i:1514906749;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<article class="sidebar-v2__article">
    <div class="met_article">
        <div class="met_editor met_module1">
            <?php if(is_array($list1) || $list1 instanceof \think\Collection): $i = 0; $__LIST__ = $list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <p><?php echo $vo['title']; ?>：<?php echo $vo['conten']; ?></p>
            <?php endforeach; endif; else: echo "" ;endif; if(is_array($list2) || $list2 instanceof \think\Collection): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <p><?php echo $vo['title']; ?>：<?php echo $vo['conten']; ?></p>
