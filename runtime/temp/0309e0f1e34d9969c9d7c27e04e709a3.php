<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\PHP\project\zd\public/../application/home\view\cases\index.html";i:1516119063;s:65:"E:\PHP\project\zd\public/../application/home\view\pub\header.html";i:1515513717;s:65:"E:\PHP\project\zd\public/../application/home\view\pub\footer.html";i:1514906749;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
   ...
   <div class="met_article"> 
    <div class="product-v2"> 
     <ul class="product-v2__list list-unstyled">
      ...
      <li class="col-lg-3 col-md-4 col-sm-6 v2-mtb15"> <a href="<?php echo url('cases/case_detail',array('articlesID'=>$vo['articlesID'])); ?>" title="<?php echo $vo['title']; ?>" target="_self"> <img src="<?php echo $vo['url']; ?>" />
       <!--x="600" y="500"--> </a>
       <div class="product-v2__list__box v2-ac product-v2__dg">
        <h2><?php echo $vo['title']; ?></h2>
        <ol class="list-unstyled v2-ac v2-mt15">
         <li class="col-xs-4"><em>面积</em><span><?php echo $vo['area']; ?>m&sup2;</span></li>
         <li class="col-xs-4"><em>地址</em><span>中国</span></li>
         <li class="col-xs-4"><em>风格</em><span>现代</span></li>
        </ol>
        <p class="v2-mt15 v2-lc"><i>●</i><?php echo $vo['describe']; ?>...</p>
        <a href="<?php echo url('cases/case_detail',array('articlesID'=>$vo['articlesID'])); ?>" title="<?php echo $vo['title']; ?>" class="v2-mt15" target="_self">查看详情<i class="glyphicon glyphicon-menu-right"></i></a>
       </div>
      </li>
