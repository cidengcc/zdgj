...
$(function(){
    $(window).resize(function(){
        ...
        $(".upload-img-box").click(function(){
            ...
            //弹出图片大小限制
            if($('#uploadPop img').width()/$('#uploadPop img').height()*2>3){
                $('#uploadPop img').width(1200);
                $('#uploadPop img').height($('#uploadPop img').height()/$('#uploadPop img').width()*1200);
            }else{
                $('#uploadPop img').height(800);
                $('#uploadPop img').width($('#uploadPop img').width()/$('#uploadPop img').height()*800);
            }
            // 弹出层定位
            ...
            m.mousedown(function(e){
                ...
                sX = e.clientX - m.offset().left;
                sY = e.clientY - m.offset().top;
                return false
            })
